  ...
  <div class="tiendas text-start" >
    ...
    <div class="container-lg">
      <div class="row">
        <div class="col-md-2 ">
          <aside class="navbar">
            <img src="../assets/tiendas_hyperchollo.jpg" class="card-img-top" alt="...">
            <h3>Tabla de contenido</h3>
            <nav>
                <a href="#">¿Qué encontraras en nuestras tiendas asociadas?</a>
                <a href="#">Forma parte de nuestra plataforma</a>
                <a href="#">Benefíciate de nuestra plataforma</a>
            </nav>
          </aside>
        </div>
